...
import { setExperienceServices, setBeautyServices, setPromotionServices, setServices } from '../actions';
        ...
        <LinearGradient
            ...
            <TouchableHighlight
                ...
                onPress={() => {
                    ...
                    setTimeout(() => {
                        setIsPress(false);
                        props.setBeautyServices(props.services.id, props.services.title);
                        navigation.navigate('BeautyBusiness');
                    }, 0)
                }}
            >
...
const mapDispatchToProps = (dispatch) => ({
    setBeautyServices: (id, name) => {
        const data = {
            id: id,
            name: name,
        };
        dispatch(setBeautyServices(data));
    },
});
