...
import { setCarouselCurrentIndexAll, setBeauty, setPromotion, setWhatsOn } from '../actions';

const BeautyTile = (props) => {
                ...
                onPress={() => {
                    if (props.embed_url == null) {
                        ...
                        setTimeout(() => {
                            ...
                            props.setBeauty(props.id, props.title);
                            navigation.navigate('childCategoriesBeauty');
                        }, 500);
                    } else {
...
export default connect(mapStateToProps, mapDispatchToProps)(BeautyTile);
