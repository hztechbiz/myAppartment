...
import { setCarouselCurrentIndexAll, setExperience, setPromotion } from '../actions';
      ...
      <TouchableHighlight
        ...
        onPress={() => {
          ...
          setTimeout(() => {
            ...
            props.setExperience(props.id, props.title);
            navigation.navigate('childCategoriesEx');
          }, 500);
        }}>
