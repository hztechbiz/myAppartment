...
import {setCarouselCurrentIndexAll, setCarouselTotalIndexAll, setChildPromotion, setChildWhatsOn, setFeedback} from '../actions';
...
const WhatsOn = (props) => {
  ...
  const fetchCategories = () => {
    const url = `${apiActiveURL}/categories?subrub=${props.suburb}&area=${props.area}&listing_type=8`;
    const options = {
      method: 'GET',
      headers: {
        AppKey: appKey,
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TitleBar title={`WHAT'S ON`} sub={true} />
      <View
        style={{
          height: '55%',
          //marginTop: 20,
