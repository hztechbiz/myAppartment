    ...
    <SafeAreaView
      ...
      <ScrollView >
        <View
          ...
          />
          <Text style={{textAlign: 'center', color: '#6a6a6b', paddingHorizontal: 40, fontSize: 11}}>Forgot your Password? No Issues, Just</Text>
          <TextInput
            style={styles.input}
          ...
          <TouchableOpacity
            ...
            {loader === true ? (
              ...
              <Text style={{color: '#fff'}}>GET CONFIRMATION CODE</Text>
            )}
          </TouchableOpacity>
          <TouchableOpacity style={styles.btn2} onPress={() => props.navigation.navigate('ForgotUsername')}>
            <Text style={{color: '#a1a3a6'}}>Forgot Username</Text>
          </TouchableOpacity>
          {/* <TouchableOpacity
            style={styles.btn2}
            onPress={() => {
