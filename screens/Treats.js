...
import { setChildCategory, setFeedback, setServices, signOut, checkOut } from '../actions';
import FeedbackModal from '../components/FeedbackModal';
// import { handleSessionId } from '../components/Logout';
import TreatTile from '../components/TreatTile';
...
const Treats = (props) => {
    ...
    const fetchTreats = () => {
        ...
        url = `${apiActiveURL}/treats?area=${props.area}`
...
export default connect(mapStateToProps, mapDispatchToProps)(Treats);
