...
import ChildBeautyTile from '../components/childBeautyTile';
import Carousel from '../components/Carousel';

const screenWidth = Dimensions.get('window').width;

const childCategoriesOthers = (props) => {
  ...
  useEffect(() => {
    // console.log(props.carouselCurrentIndex,'props.carouselCurrentIndex')
    // setCurrentIndex(props.carouselCurrentIndex)
    setCurrentIndex(1);

    // console.log(props.carouselCurrentIndex)
      ...
      .then((res) => {
        ...
        if (res.data.code === 200) {
          if (Object.values(res.data.data).length > 0) {
            console.log('render child ======', res.data.data);
            ...
            props.setFeedback('IconResort', 'No Data Found', true, 'Beauty');
...
const mapStateToProps = (state) => ({
  ...
  ChildProName: state.ChildOthers.name,
